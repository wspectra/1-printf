...
static void	ft_put_hex(t_strt *strt, unsigned long int nb, int len)
{
...
static void	ft_hex_width(t_strt *strt, int len, unsigned long int nb)
{
	if (strt->minus && strt->width > 0)
	{
		write(1, "0x", 2);
